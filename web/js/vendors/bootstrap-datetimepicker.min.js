...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
		...
		'az':
		{
			...
			'less-than' : 'Tarix araligi %d g�nd?n �ox olmamalidir',
			'more-than' : 'Tarix araligi %d g�nd?n az olmamalidir',
			'default-more' : '%d g�nd?n �ox bir tarix se�in',
			'default-single' : 'Tarix se�in',
			'default-less' : '%d g�nd?n az bir tarix se�in',
			'default-range' : '%d v? %d g�n araliginda tarixl?r se�in',
			'default-default': 'Tarix araligi se�in'
		},
		...
		'fr':
		{
			...
			'week-6' : 'sa',
			'week-7' : 'di',
			'month-name': ['janvier','f�vrier','mars','avril','mai','juin','juillet','aout','septembre','octobre','novembre','d�cembre'],
			...
			'next-month':'Mois',
			'next-year':'Ann�e',
			'less-than' : 'L\'intervalle ne doit pas etre sup�rieure a %d jours',
			'more-than' : 'L\'intervalle ne doit pas etre inf�rieure a %d jours',
			'default-more' : 'Merci de choisir une intervalle sup�rieure a %d jours',
