...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
		...
		'az':
		{
			...
			'shortcuts' : 'Qisayollar',
			'past': 'Keçmiº',
			'following':'Növb?ti',
			'previous' : '&nbsp;&nbsp;&nbsp;',
			'prev-week' : 'Önc?ki h?ft?',
			'prev-month' : 'Önc?ki ay',
			'prev-year' : 'Önc?ki il',
			'next': '&nbsp;&nbsp;&nbsp;',
			'next-week':'Növb?ti h?ft?',
			'next-month':'Növb?ti ay',
			'next-year':'Növb?ti il',
			'less-than' : 'Tarix araligi %d günd?n çox olmamalidir',
			'more-than' : 'Tarix araligi %d günd?n az olmamalidir',
			'default-more' : '%d günd?n çox bir tarix seçin',
			'default-single' : 'Tarix seçin',
			'default-less' : '%d günd?n az bir tarix seçin',
			'default-range' : '%d v? %d gün araliginda tarixl?r seçin',
			'default-default': 'Tarix araligi seçin'
		},
		...
		'cz':
		{
			...
			'week-6' : 'so',
			'week-7' : 'ne',
			'month-name': ['leden','únor','bøezen','duben','kvìten','èerven','èervenec','srpen','záøí','øíjen','listopad','prosinec'],
			'shortcuts' : 'Zkratky',
			'past': 'po',
			...
			'next-month':'mìsíc',
			'next-year':'rok',
			'less-than' : 'Rozsah data by nemìl být vìtší než %d dnù',
			'more-than' : 'Rozsah data by nemìl být menší než %d dnù',
			'default-more' : 'Prosím zvolte rozsah data vìtší než %d dnù',
			'default-single' : 'Prosím zvolte datum',
			'default-less' : 'Prosím zvolte rozsah data menší než %d dnù',
		...
		'fr':
		{
			...
			'week-6' : 'sa',
			'week-7' : 'di',
			'month-name': ['janvier','février','mars','avril','mai','juin','juillet','aout','septembre','octobre','novembre','décembre'],
			...
			'next-month':'Mois',
			'next-year':'Année',
			'less-than' : 'L\'intervalle ne doit pas etre supérieure a %d jours',
			'more-than' : 'L\'intervalle ne doit pas etre inférieure a %d jours',
			'default-more' : 'Merci de choisir une intervalle supérieure a %d jours',
		...
		'hu':
		{
			...
			'default-more' : 'Válassz ki egy idõszakot ami hosszabb mint %d nap',
			'default-single' : 'Válassz egy napot',
			'default-less' : 'Válassz ki egy idõszakot ami rövidebb mint %d nap',
			'default-range' : 'Válassz ki egy %d - %d nap hosszú idõszakot',
			'default-default': 'Válassz ki egy idõszakot'
		},
		'it':
		{
		...
		'no':
		{
			...
			'next-month':'Maned',
			'next-year':'Ar',
			'less-than' : 'Datoperioden skal ikkje vare lengre enn %d dager',
			'more-than' : 'Datoperioden skal ikkje vare kortere enn %d dager',
		...
		'pl':
		{
			...
			'week-6' : 'so',
			'week-7' : 'nd',
			'month-name': ['styczeñ','luty','marzec','kwiecieñ','maj','czerwiec','lipiec','sierpieñ','wrzesieñ','paŸdziernik','listopad','grudzieñ'],
			'shortcuts' : 'Skróty',
			'custom-values': 'Niestandardowe wartoœci',
			'past': 'Przesz³e',
			'following':'Nastêpne',
			'previous' : 'Poprzednie',
			'prev-week' : 'tydzieñ',
			...
			'next-month':'miesi¹c',
			'next-year':'rok',
			'less-than' : 'Okres nie powinien byæ d³u¿szy ni¿ %d dni',
			'more-than' : 'Okres nie powinien byæ krótszy ni¿  %d ni',
			'default-more' : 'Wybierz okres d³u¿szy ni¿ %d dni',
			'default-single' : 'Wybierz datê',
			'default-less' : 'Wybierz okres krótszy ni¿ %d dni',
